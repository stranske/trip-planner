...
def test_prepare_prompt_requires_description_evidence_for_the_linked_followup_pr(
    monkeypatch,
):
    context = """
### Related Issues/PRs
...
def test_prepare_prompt_accepts_wrapped_body_evidence_for_linked_followup_pr(
    monkeypatch,
):
    context = """
## Thread 1

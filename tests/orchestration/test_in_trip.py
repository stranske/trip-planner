...
def _fixture_path(name: str) -> Path:
    return Path(__file__).resolve().parents[1] / "fixtures" / "orchestration" / "in_trip" / name
...
def test_budget_drift_event_routes_into_reranking() -> None:
    ...
    assert result.planner_turn.next_step.recommended_action_id == ("action-refresh-ranking")

...
- `TPP_ORGANIZATION_ID`: deployment-owned organization for workspace policy sync. Configure it alongside the live TPP transport; travellers cannot override it through the sync API. Without it, policy sync returns 503 naming this key.

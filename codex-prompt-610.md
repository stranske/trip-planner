...
### Scope
The first two epics define preference foundations, shared contracts, business-profile contracts, and source/provenance structures, but the planner still lacks the normalized planning objects that actual option generation will use. Before live source adapters, ranking, or map-aware route assembly, the repo needs canonical contracts for places, lodging, transport, activities, and mixed inventory bundles.
...
- [x] #520 Define normalized destination and place-context contracts
- [x] #521 Implement the canonical LodgingOption contract
- [x] #522 Implement the canonical TransportOption contract
- [x] #523 Implement the canonical ActivityOption contract
- [ ] #524 Build inventory-bundle and mixed option-assembly contracts

### Acceptance Criteria
The PR is complete when ALL of these are satisfied:

- [ ] All child issues needed for normalized inventory contracts and early option modeling are completed.
- [ ] Destination, lodging, transport, and activity contracts remain distinct but compatible.
- [ ] The resulting option model is explicit about provenance, feasibility, quality/value/fit summaries, and option-bundle assembly.
- [ ] Later ingestion and ranking issues can build on this layer without redefining the underlying option objects.

### Recently Attempted Tasks
Avoid repeating these unless a task needs explicit follow-up:

- #520 Define normalized destination and place-context contracts
- #521 Implement the canonical LodgingOption contract
- #522 Implement the canonical TransportOption contract

### Suggested Next Task
- #523 Implement the canonical ActivityOption contract
